...
import dem_proc,dem_proc_inverse,testing_proc
import sys
...
while True:
    ...
    if cv2.waitKey(10) == 27:
        ...
        loc_data = testing_proc.process_model(original_ortho_array,dem_file,dtm_file,upscaled_coords,min_contour_area,max_contour_area,min_cutoff_percent,max_cutoff_percent,shapefile_choice)
        print("\nElevations are\n")
